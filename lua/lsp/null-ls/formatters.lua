...
function contains(t, predicate)
	return find_first(t, predicate) ~= nil
end
...
function M.list_available(filetype)
	...
	for _, provider in pairs(null_ls.builtins.formatting) do
		if contains(provider.filetypes or {}, function(ft)
